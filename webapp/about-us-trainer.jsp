...
<body class="host_version">
	...
	<div class="container">
		<div class="row pad-botm">
			<div class="col-md-12">
				<h3 class="header-line">About Dietitian</h3>
			</div>
		</div>
		<div class="row">
				...
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<div class="form-group">
							<label>Dietitian Name : </label> <font color="orange"><%=resultset.getString("dname")%></font>
						</div>
						<div class="form-group">
							<label>About Us : </label>&nbsp;<%=resultset.getString("about_us") %>
						</div>
						<hr>
						<%
							}
